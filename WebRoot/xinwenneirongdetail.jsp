...
<div class="section">
  <div class="kcBox clear-fix">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>新闻分类：</td><td width='39%'>${xinwenneirong.xinwenfenlei}</td><td  rowspan=4 align=center><a href=${xinwenneirong.tupian} target=_blank><img src=${xinwenneirong.tupian}  width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>标题：</td><td width='39%'>${xinwenneirong.biaoti}</td></tr><tr>                                    <td width='11%' height=44>点击率：</td><td width='39%'>${xinwenneirong.dianjilv}</td></tr><tr>         <td width='11%' height=44>添加人：</td><td width='39%'>${xinwenneirong.tianjiaren}</td></tr><tr>         <td width='11%' height=100  >内容：</td><td width='39%' colspan=2 height=100 >${xinwenneirong.neirong}</td></tr><tr><td width='11%' height=100  >描述：</td><td width='39%' colspan=2 height=100 >${xinwenneirong.tianjiaren}</td></tr><tr>							 
                                <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("xinwenneirong",id)){
	pli=pli+1;
     %>
                                   <tr>
                                ...
                                </tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()" /> <!--jixaaxnnxiu--><input type=button name=Submit53 value=评论 onClick="javascript:hsgpinglun('xinwenneirong','<%=id%>')"/><!-- <input type=button name=Submit52 value=收藏 onClick="javascript:location.href='jrsc.jsp?id=<%=id%>&biao=xinwenneirong&ziduan=biaoti';" /> --></td></tr>
