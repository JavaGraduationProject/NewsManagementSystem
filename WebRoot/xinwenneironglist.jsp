...
<div class="section">
  <div class="kcBox clear-fix">
    <div class="knowList3 clear-fix">
      ...
      <!-- end Ttitle-->
      <ul class="knowListUl2" style="color:#000">
	                          
							  
							  
<form action="xwnrList.do?xinwenfenlei=${fenlei}" name="myform" method="post">
									查询  标题：<input name="biaoti" type="text" id="biaoti" style='border:solid 1px #000000; color:#666666' size="12" />
									<input type="submit" value="查询" /> <input type="button" name="Submit2" value="切换视图"  onClick="javascript:location.href='xwnrListtp.do';" />
								</form>	
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.xinwenfenlei}</td>    <td>${u.biaoti}</td>            <td width='90'><a href='${u.tupian}' target='_blank'><img src='${u.tupian}' width=88 height=99 border=0 /></a></td>    <td>${u.dianjilv}</td>    <td>${u.tianjiaren}</td>    
                              ...
                              <td align="center"><a href="xwnrDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="xwnrList.do?page=1&xinwenfenlei=${fenlei}" >首页</a>
             <a href="xwnrList.do?page=${page.page-1 }&xinwenfenlei=${fenlei}"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}&xinwenfenlei=${fenlei}">
			<a href="xwnrList.do?page=${page.page+1 }&xinwenfenlei=${fenlei}">下一页</a>
			<a href="xwnrList.do?page=${page.totalPage }&xinwenfenlei=${fenlei}">末页</a>		    </c:if>		
	</c:if>
	</p>
