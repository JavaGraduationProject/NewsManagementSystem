...
-->
	...
	<body>
			<form action="updateXinwenfabu2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改新闻发布<input type="hidden" name="id" value="${xinwenfabu.id}" /></td>
						</tr>
		...
		<tr ><td width="200">联系电话：</td><td><input name='lianxidianhua' type='text' id='lianxidianhua' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
						...
						<script language="javascript">document.form1.zhanghao.value='${xinwenfabu.zhanghao}';</script>
	<script language="javascript">document.form1.mima.value='${xinwenfabu.mima}';</script>
	<script language="javascript">document.form1.touxiang.value='${xinwenfabu.touxiang}';</script>
	<script language="javascript">document.form1.xingming.value='${xinwenfabu.xingming}';</script>
	<script language="javascript">document.form1.lianxidianhua.value='${xinwenfabu.lianxidianhua}';</script>
